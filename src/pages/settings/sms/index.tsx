              ...
              <div className="col">
                <div className="row">
                  <div className="col-12 mb-5">
                    <h2 className="text-2xl dark:text-white font-bold">SMS</h2>
                  </div>
                    ...
                    <div className="bg-white dark:bg-gray-800 dark:border-gray-700 rounded-lg h-full border p-5">
                      <div className="row">
                        <div className="col-12 col-lg-7 mx-auto">
                          ...
                          <p className="text-base text-center text-gray-500 dark:text-white mb-5">
                            90% of text messages are read within 3 minutes!
                            If you want to make sure your reminders, promotions and news are actually seen by your customers SMS marketing is for you. Learn more
                          </p>
                        </div>
                      </div>
                      <div className="row">
